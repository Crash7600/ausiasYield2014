...
import net.daw.dao.specific.implementation.PeliculaDaoSpcImpl;
 ...
 * @author al037805
 */
public class PeliculaServiceSpImpl implements TableServiceInterface, ViewServiceInterface, MetaServiceInterface {

    protected Connection oConnection = null;
    protected String strObjectName = null;
    protected String strPojo = null;

    public PeliculaServiceSpImpl(String strObject, String pojo, Connection con) {
    ...
    public String remove(Integer id) throws Exception {
        ...
        try {
            ...
            PeliculaDaoSpcImpl oPeliculaDAO = new PeliculaDaoSpcImpl(strObjectName, oConnection);
            PeliculaBeanGenSpImpl oPelicula = new PeliculaBeanGenSpImpl(id);
    ...
    public String get(Integer id) throws Exception {
        ...
        try {
            ...
            PeliculaDaoSpcImpl oPeliculaDAO = new PeliculaDaoSpcImpl(strObjectName, oConnection);
            PeliculaBeanGenSpImpl oPelicula = new PeliculaBeanGenSpImpl(id);
            oPelicula = oPeliculaDAO.get(oPelicula, 1);
            GsonBuilder gsonBuilder = new GsonBuilder();
            gsonBuilder.setDateFormat("dd/MM/yyyy");
            Gson gson = gsonBuilder.create();
            data = gson.toJson(oPelicula);
            oConnection.commit();
        } catch (Exception ex) {
            oConnection.rollback();
    ...
    public String getPage(int intRegsPerPag, int intPage, ArrayList<FilterBeanHelper> alFilter, HashMap<String, String> hmOrder) throws Exception {
        ...
        try {
            oConnection.setAutoCommit(false);
            PeliculaDaoSpcImpl oPeliculaDAO = new PeliculaDaoSpcImpl(strObjectName, oConnection);
            List<PeliculaBeanGenSpImpl> oPeliculas = oPeliculaDAO.getPage(intRegsPerPag, intPage, alFilter, hmOrder);
            GsonBuilder gsonBuilder = new GsonBuilder();
            gsonBuilder.setDateFormat("dd/MM/yyyy");
            Gson gson = gsonBuilder.create();
            data = gson.toJson(oPeliculas);
            data = "{\"list\":" + data + "}";
            oConnection.commit();
        } catch (Exception ex) {
            oConnection.rollback();
    ...
    public String getPages(int intRegsPerPag, ArrayList<FilterBeanHelper> alFilter) throws Exception {
        ...
        try {
            oConnection.setAutoCommit(false);
            PeliculaDaoSpcImpl oPeliculaDAO = new PeliculaDaoSpcImpl(strObjectName, oConnection);
            int pages = oPeliculaDAO.getPages(intRegsPerPag, alFilter);
    ...
    public String getCount(ArrayList<FilterBeanHelper> alFilter) throws Exception {
        ...
        try {
            oConnection.setAutoCommit(false);
            PeliculaDaoSpcImpl oPeliculaDAO = new PeliculaDaoSpcImpl(strObjectName, oConnection);
            int registers = oPeliculaDAO.getCount(alFilter);
    ...
    public String getPrettyColumns() throws Exception {
        ...
        try {
            oConnection.setAutoCommit(false);
            PeliculaDaoSpcImpl oPeliculaDAO = new PeliculaDaoSpcImpl(strObjectName, oConnection);
            alColumns = oPeliculaDAO.getPrettyColumnsNames();
