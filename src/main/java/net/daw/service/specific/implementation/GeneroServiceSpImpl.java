...
import net.daw.dao.specific.implementation.GeneroDaoSpcImpl;
 ...
 * @author al037805
 */
public class GeneroServiceSpImpl implements TableServiceInterface, ViewServiceInterface, MetaServiceInterface {

    protected Connection oConnection = null;
    protected String strObjectName = null;
    protected String strPojo = null;

    public GeneroServiceSpImpl(String strObject, String pojo, Connection con) {
    ...
    public String set(String jason) throws Exception {
        ...
        try {
            oConnection.setAutoCommit(false);
            GeneroDaoSpcImpl oGeneroDAO = new GeneroDaoSpcImpl(strObjectName, oConnection);
            GeneroBeanGenSpImpl oGenero = new GeneroBeanGenSpImpl();
    ...
    public String getPages(int intRegsPerPag, ArrayList<FilterBeanHelper> alFilter) throws Exception {
        ...
        try {
            oConnection.setAutoCommit(false);
            GeneroDaoSpcImpl oGeneroDAO = new GeneroDaoSpcImpl(strObjectName, oConnection);
            int pages = oGeneroDAO.getPages(intRegsPerPag, alFilter);
    ...
    public String getCount(ArrayList<FilterBeanHelper> alFilter) throws Exception {
        ...
        try {
            oConnection.setAutoCommit(false);
            GeneroDaoSpcImpl oGeneroDAO = new GeneroDaoSpcImpl(strObjectName, oConnection);
            int registers = oGeneroDAO.getCount(alFilter);
    ...
    public String getPrettyColumns() throws Exception {
        ...
        try {
            oConnection.setAutoCommit(false);
            GeneroDaoSpcImpl oGeneroDAO = new GeneroDaoSpcImpl(strObjectName, oConnection);
            alColumns = oGeneroDAO.getPrettyColumnsNames();
    ...
    public String getColumns() throws Exception {
        ...
        try {
            ...
            ArrayList<String> alColumns = null;
            GeneroDaoSpcImpl oGeneroDAO = new GeneroDaoSpcImpl(strObjectName, oConnection);
            alColumns = oGeneroDAO.getColumnsNames();
            data = new Gson().toJson(alColumns);
            //data = "{\"data\":" + data + "}";
            oConnection.commit();
