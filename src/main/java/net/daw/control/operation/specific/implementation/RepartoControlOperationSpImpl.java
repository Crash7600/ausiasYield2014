...
import net.daw.service.specific.implementation.RepartoServiceSpImpl;

/**
 *
 * @author al037805
 */
public class RepartoControlOperationSpImpl implements ControlOperationInterface{
    
    private ConnectionInterface DataConnectionSource = null;
    private Connection oConnection = null;
    private RepartoServiceSpImpl oRepartoService = null;

    public RepartoControlOperationSpImpl(HttpServletRequest request) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, Exception {
        try {
            DataConnectionSource = new BoneConnectionPoolImpl();
            oConnection = DataConnectionSource.newConnection();
            oRepartoService = new RepartoServiceSpImpl(ParameterCooker.prepareObject(request), ParameterCooker.prepareObject(request), oConnection);
        } catch (Exception ex) {
            ExceptionBooster.boost(new Exception(this.getClass().getName() + ":RepartoControlOperationSpImpl ERROR: " + ex.getMessage()));
        }
    }
    ...
    public String get(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oRepartoService.get(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String getaggregateviewone(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oRepartoService.getAggregateViewOne(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String getprettycolumns(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oRepartoService.getPrettyColumns();
            closeDB();
        } catch (Exception ex) {
    ...
    public String getcolumns(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oRepartoService.getColumns();
            closeDB();
        } catch (Exception ex) {
    ...
    public String getpage(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            result = oRepartoService.getPage(intRegsPerPag, intPage, alFilter, hmOrder);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getpages(HttpServletRequest request) throws Exception {
        ...
        try {
            Integer intRegsPerPag = ParameterCooker.prepareRpp(request);
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            result = oRepartoService.getPages(intRegsPerPag, alFilter);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getregisters(HttpServletRequest request) throws Exception {
        ...
        try {
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            result = oRepartoService.getCount(alFilter);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getaggregateviewsome(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            HashMap<String, String> hmOrder = ParameterCooker.prepareOrder(request);
            result = oRepartoService.getAggregateViewSome(intRegsPerPag, intPage, alFilter, hmOrder);
            closeDB();
        } catch (Exception ex) {
    ...
    public String remove(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oRepartoService.remove(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String set(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oRepartoService.set(ParameterCooker.prepareJson(request));
            closeDB();
        } catch (Exception ex) {
