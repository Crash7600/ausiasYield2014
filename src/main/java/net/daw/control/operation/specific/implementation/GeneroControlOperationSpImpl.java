...
import net.daw.service.specific.implementation.GeneroServiceSpImpl;

/**
 *
 * @author al037805
 */
public class GeneroControlOperationSpImpl implements ControlOperationInterface{
    
    private ConnectionInterface DataConnectionSource = null;
    private Connection oConnection = null;
    private GeneroServiceSpImpl oGeneroService = null;

    public GeneroControlOperationSpImpl(HttpServletRequest request) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, Exception {
        try {
            DataConnectionSource = new BoneConnectionPoolImpl();
            oConnection = DataConnectionSource.newConnection();
            oGeneroService = new GeneroServiceSpImpl(ParameterCooker.prepareObject(request), ParameterCooker.prepareObject(request), oConnection);
        } catch (Exception ex) {
    ...
    public String get(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oGeneroService.get(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String getaggregateviewone(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oGeneroService.getAggregateViewOne(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String getprettycolumns(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oGeneroService.getPrettyColumns();
            closeDB();
        } catch (Exception ex) {
    ...
    public String getcolumns(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oGeneroService.getColumns();
            closeDB();
        } catch (Exception ex) {
    ...
    public String getpage(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            result = oGeneroService.getPage(intRegsPerPag, intPage, alFilter, hmOrder);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getpages(HttpServletRequest request) throws Exception {
        ...
        try {
            Integer intRegsPerPag = ParameterCooker.prepareRpp(request);
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            result = oGeneroService.getPages(intRegsPerPag, alFilter);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getregisters(HttpServletRequest request) throws Exception {
        ...
        try {
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            result = oGeneroService.getCount(alFilter);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getaggregateviewsome(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            HashMap<String, String> hmOrder = ParameterCooker.prepareOrder(request);
            result = oGeneroService.getAggregateViewSome(intRegsPerPag, intPage, alFilter, hmOrder);
            closeDB();
        } catch (Exception ex) {
    ...
    public String remove(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oGeneroService.remove(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String set(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oGeneroService.set(ParameterCooker.prepareJson(request));
            closeDB();
        } catch (Exception ex) {
