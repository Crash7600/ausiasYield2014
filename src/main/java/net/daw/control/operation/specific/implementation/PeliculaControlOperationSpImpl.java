...
import net.daw.service.specific.implementation.PeliculaServiceSpImpl;

/**
 *
 * @author al037805
 */
public class PeliculaControlOperationSpImpl implements ControlOperationInterface{
    
    private ConnectionInterface DataConnectionSource = null;
    private Connection oConnection = null;
    private PeliculaServiceSpImpl oPeliculaService = null;

    public PeliculaControlOperationSpImpl(HttpServletRequest request) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, Exception {
        try {
            DataConnectionSource = new BoneConnectionPoolImpl();
            oConnection = DataConnectionSource.newConnection();
            oPeliculaService = new PeliculaServiceSpImpl(ParameterCooker.prepareObject(request), ParameterCooker.prepareObject(request), oConnection);
        } catch (Exception ex) {
            ExceptionBooster.boost(new Exception(this.getClass().getName() + ":PeliculaControlOperationSpImpl ERROR: " + ex.getMessage()));
        }
    }
    ...
    public String get(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oPeliculaService.get(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String getaggregateviewone(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oPeliculaService.getAggregateViewOne(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String getprettycolumns(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oPeliculaService.getPrettyColumns();
            closeDB();
        } catch (Exception ex) {
    ...
    public String getcolumns(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oPeliculaService.getColumns();
            closeDB();
        } catch (Exception ex) {
    ...
    public String getpage(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            result = oPeliculaService.getPage(intRegsPerPag, intPage, alFilter, hmOrder);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getpages(HttpServletRequest request) throws Exception {
        ...
        try {
            Integer intRegsPerPag = ParameterCooker.prepareRpp(request);
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            result = oPeliculaService.getPages(intRegsPerPag, alFilter);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getregisters(HttpServletRequest request) throws Exception {
        ...
        try {
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            result = oPeliculaService.getCount(alFilter);
            closeDB();
        } catch (Exception ex) {
    ...
    public String getaggregateviewsome(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            ArrayList<FilterBeanHelper> alFilter = ParameterCooker.prepareFilter(request);
            HashMap<String, String> hmOrder = ParameterCooker.prepareOrder(request);
            result = oPeliculaService.getAggregateViewSome(intRegsPerPag, intPage, alFilter, hmOrder);
            closeDB();
        } catch (Exception ex) {
    ...
    public String remove(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oPeliculaService.remove(ParameterCooker.prepareId(request));
            closeDB();
        } catch (Exception ex) {
    ...
    public String set(HttpServletRequest request) throws Exception {
        String result = null;
        try {
            result = oPeliculaService.set(ParameterCooker.prepareJson(request));
            closeDB();
        } catch (Exception ex) {
